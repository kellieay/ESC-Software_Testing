...
//					String item = String.valueOf(ele.charAt(0).startsWith("\"") ? headersLs.get(i).substring(1, headersLs.get(i).length() - 1) : headersLs.get(i));
	...
	public static void main(String[] args) throws IOException {
		...
		List<String> differenceLs = new ArrayList<String>();
		boolean res = compareCols("/Users/kellieayy/ESC-Software_Testing/ESC-SoftwareMiniTest/src/compareCSV/sample_file_1.csv", "/Users/kellieayy/ESC-MiniTesting/ESC-SoftwareMiniTest/src/compareCSV/sample_file_3.csv");
		if (res == true) {
			List<String> headerLs = getHeaders("/Users/kellieayy/ESC-Software_Testing/ESC-SoftwareMiniTest/src/compareCSV/sample_file_1.csv");
